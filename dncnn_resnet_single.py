...
class fixed_loss(nn.Module):
    ...
    def forward(self, img,  gt_image, est_noise, gt_noise, if_asym):
        # l2_loss = F.mse_loss(img, gt_image)
        l2_loss = F.l1_loss(img, gt_image)
        ...
        loss = 10 * l2_loss + (0.5 * asym_loss) + (0.05 * tvloss)
